...
public class CountyController {
    ...
    public ElectionData sendCountyPresidentialVoteData(@PathVariable String stateId, @PathVariable String countyId,
    ...
    public void receiveCountyPresidentialVoteData(@PathVariable String stateId, @PathVariable String countyId,
                                                  @PathVariable int year, ElectionData data) {
    ...
    public ElectionData sendCountyCongressionalVoteData(@PathVariable String stateId, @PathVariable String countyId,
                                                       @PathVariable int year) {
